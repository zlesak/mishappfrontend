...
public class QuizResultComponent extends VerticalLayout implements I18nAware {
     ...
     */
    public QuizResultComponent(QuizValidationResult result) {
        super();
        setSpacing(true);
        setPadding(true);
        ...
        QuizScoreCard scoreCard = new QuizScoreCard(result);
        QuizResultDetailCard detailsCard = new QuizResultDetailCard(result);
