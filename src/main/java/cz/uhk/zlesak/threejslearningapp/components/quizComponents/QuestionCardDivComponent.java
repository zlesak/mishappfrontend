 ...
 */
public class QuestionCardDivComponent extends Div implements I18nAware {
     ...
     */
    public QuestionCardDivComponent(AbstractQuestionData question, int questionNumber, Map<String, AbstractSubmissionData> answers) {
        super();
        setWidthFull();
